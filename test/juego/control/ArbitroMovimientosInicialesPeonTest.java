...
public class ArbitroMovimientosInicialesPeonTest {
	...
	*/
	...
	@Test
	void comprobarQuePeonQuedaMarcadoPrimerMovimentoUnaVezMovido() {
	...
	*/
	...
	@Test
	void comprobarQuePeonNoQuedaMarcadoAlSimular() {
		Celda origen = tablero.obtenerCelda(6, 4);
	...
	*/
	...
	@Test
	void comprobarQueNoPuedeAvanzarDistanciaDosUnPeonDosVeces() {
		Celda origen = tablero.obtenerCelda(6, 4);
		Celda destino = tablero.obtenerCelda(4, 4);
		arbitro.mover(origen, destino);
